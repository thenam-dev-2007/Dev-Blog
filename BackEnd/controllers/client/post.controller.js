...
function getThumbnailFromRequest(req, fallback) {
  if (req.file) return `/upload/thumbnail/${req.file.filename}`;
...
module.exports.createPost = async (req, res, next) => {
  try {
    ...
    const newPost = await Post.create({
      title,
      content,
      thumbnail: getThumbnailFromRequest(req, thumbnail),
...
module.exports.updatePost = async (req, res, next) => {
  try {
    ...
    if (req.file) updateData.thumbnail = `/upload/thumbnail/${req.file.filename}`;
